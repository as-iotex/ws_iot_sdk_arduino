 ...
 protected:
  ...
  void ImportAesKey(psa_key_id_t *source_key, psa_key_attributes_t *attr, bool allowCopy = true)
  {
    ...
    *attr = PSA_KEY_ATTRIBUTES_INIT;
    ...
    if(allowCopy) { psa_set_key_usage_flags(attr, PSA_KEY_USAGE_COPY); }
...
// TODO Test key location, algorithm, size are combined from source and input attributes and verified
