...
void setup()
{
  ...
  Serial.println("This example shows how to use the W3bstream PSA Crypto API compute and validate a hash using a one shot operation.");
  Serial.println("--------------------------------------------------------------------\n");
  ...
  status = psa_hash_compute(PSA_ALG_SHA_256, message, sizeof(message), hash, sizeof(hash), &hashLenght);
