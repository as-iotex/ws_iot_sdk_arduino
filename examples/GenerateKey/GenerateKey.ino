...
void setup()
{
  ...
  Serial.println("This example shows how to use the W3bstream PSA Crypto API to generate a key that can be use for encryption and decryption.");
  Serial.println("Note: This example is only for demonstration purposes. Production applications should seed the random generator with enough entropy before generating a key.");
  Serial.println("--------------------------------------------------------------------\n");
